...
UUID = os.environ.get('UUID', '296c8967-b834-41a6-a2dc-b3a63c7a572e')  # UUID
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nz.woairenqi.eu.cc:11111')      # 哪吒面板域名,v0：nezha.xxx.com  v1: nezha.xxx.com:8008
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')          # v1留空, v0填agent通信端口
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'ubpmaEb3yFt2VBc4iI9yW0QW0avBtjWi')            # v1的NZ_CLIENT_SECRET或v0 agent密钥
...
NAME = os.environ.get('NAME', 'infrlo')                      # 节点名称
